...
import com.congyan.mapper.AccountMapper;
import com.congyan.service.AccountService;
import com.congyan.utils.Const;
import com.congyan.utils.FlowUtils;
...
public class AccountServiceImpl extends ServiceImpl<AccountMapper, Account> implements AccountService {
    ...
    public String registerEmailVerifyCode(String type, String email, String address){
        synchronized (address.intern()) {
            ...
            //todo 验证码过期记得改回三分钟，目前是十五分钟
            stringRedisTemplate.opsForValue()
                    .set(Const.VERIFY_EMAIL_DATA + email, String.valueOf(code), 15, TimeUnit.MINUTES);
            return null;
        }
    }
